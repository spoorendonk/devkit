Before starting any work, check the current state and present options:

0. Check if CLAUDE.md is minimal (fewer than 5 lines or missing build/test commands). If so, suggest running `/init` to auto-detect project details before proceeding.
